...
export function DialogContent({
  ...
  return (
    <DialogPrimitive.Portal>
      <DialogPrimitive.Overlay className="fixed inset-0 bg-[var(--pb-overlay-scrim)]" />
      <DialogPrimitive.Content
        className={cn(
          "fixed left-1/2 top-1/2 w-[min(92vw,36rem)] -translate-x-1/2 -translate-y-1/2 rounded-[var(--pb-radius-lg)] border border-[var(--pb-border-subtle)] bg-[var(--pb-surface)] p-6 shadow-[var(--pb-shadow-modal)] focus:outline-none",
          className
        )}
        {...props}
      >
