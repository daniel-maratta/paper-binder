...
internal static class PaperBinderWorkerObservabilityExtensions
{
    public static IServiceCollection AddPaperBinderWorkerObservability(
        ...
        IHostEnvironment hostEnvironment)
    {
        ...
        services.AddOpenTelemetry()
            .ConfigureResource(resource => resource.AddService("PaperBinder.Worker"))
            .WithTracing(tracing =>
            {
