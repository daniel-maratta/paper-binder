...
internal static class PaperBinderTenancyExtensions
{
    public static IServiceCollection AddPaperBinderTenancy(this IServiceCollection services)
    {
        ...
        services.AddScoped<PaperBinderExecutionUserRequestContext>();
        services.AddScoped<IRequestExecutionUserContext>(provider => provider.GetRequiredService<PaperBinderExecutionUserRequestContext>());
        services.AddScoped<IRequestExecutionUserContextSetter>(provider => provider.GetRequiredService<PaperBinderExecutionUserRequestContext>());
