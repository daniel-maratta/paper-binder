...
`v1.1.2` is merged to `main`, tagged, deployed and smoke-verified on Test, and its GitHub Release is published. The active `v1.1.3` hotfix branch stages a narrow mobile public-header correction.
