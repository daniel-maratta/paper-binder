...
[`release.yml`](../../../.github/workflows/release.yml) is documented as the canonical stable-tag release workflow in [`staging-and-versioning.md`](../../../docs/95-delivery/staging-and-versioning.md), but the draft release body is always created from [`docs/95-delivery/pr/cp17-release-preparation-and-reviewer-snapshot/description.md`](../../../docs/95-delivery/pr/cp17-release-preparation-and-reviewer-snapshot/description.md).
