...
- [T-0015: CP3 Persistence Baseline And Migration Pipeline](./tasks/T-0015-cp3-persistence-baseline-and-migration-pipeline.md) - Unblock when a Docker daemon is available so the Postgres-backed migration and integration tests can run.
