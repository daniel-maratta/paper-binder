...
- `2026-07-10`: Active v1.1 temporary planning notes were reconciled to the implemented `Start Demo` and `/start-demo` language where they served as forward direction rather than historical reference.
...
- `2026-07-10`: Manual screenshot review against the temporary landing-page concept confirmed that the root-host landing is now a dedicated dark public layout with top navigation, hero-led product framing, and an embedded product stage rather than the prior light-shell/sidebar reskin.
