...
- `docs/10-product/ux-notes.md` is treated as historical shipped-reference material during this implementation sequence.
...
- Lock `docs/10-product/ux-notes.md` as historical shipped-reference material during implementation.
