...
Do not use this document as forward presentation canon for `v1.1.0` work. Use `docs/10-product/presentation-contract-v1-1.md` and `docs/archive/presentation-history/presentation-adoption-plan-v1-1.md` instead.
...
Tenant host
`{tenant}.paperbinder.danielmaratta.com`
