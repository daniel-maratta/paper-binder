...
[T-0044's baseline snapshot](../baseline-and-review-infra/v1.1.0-baseline.md) and before `T-0041`
...
its own terms (see `docs/archive/v1-1/baseline-and-review-infra/v1.1.0-baseline.md`'s own Non-Goals for the same principle
...
- This review builds on, and does not re-derive, `T-0044`'s validation evidence (build/test/docs/browser results) recorded in `docs/archive/v1-1/baseline-and-review-infra/v1.1.0-baseline.md`. Where this review re-ran a check (dependency scans), that is noted explicitly below with its own date.
...
| F11 | Security | Low/Informational | No security headers shipped (CSP, `X-Content-Type-Options`, `Referrer-Policy`, etc.) | Cheap wins remediated 2026-07-27; CSP remains an intentional CP16 non-goal |
...
**F11 [Low/Informational] — No security headers shipped.** (Remediated 2026-07-27: the cheap-win
subset called out below — `X-Content-Type-Options`, `Referrer-Policy`, `X-Frame-Options`, and
proxy-layer HSTS — has since shipped in a dedicated hiring-review remediation pass; see
`docs/30-security/threat-model-lite.md` and `SecurityResponseHeadersMiddleware.cs`. CSP remains an
explicit non-goal, unchanged from the original CP16 decision below.)
...
`deploy/test/Caddyfile`). This matches `docs/archive/v1/checkpoints/pr/cp16-hardening-and-consistency-pass/critic-review.md`,
...
`docs/archive/v1-1/remediation/engineering-quality/code-quality-review.md` and `docs/archive/v1-1/remediation/engineering-quality/code-quality-gap-analysis.md`
were written before a remediation pass (`batch-1a`, at a commit that is an ancestor of the current
branch tip — see `docs/archive/v1-1/remediation/engineering-quality/batch-1a-summary.md`) that already fixed two of the audit's
own Top-10 items:
...
**F12 [Low, self-resolving].** `docs/archive/v1-1/baseline-and-review-infra/v1.1.0-baseline.md` states the T-0039
...
`docs/archive/v1-1/baseline-and-review-infra/v1.1.0-baseline.md`, since the code paths those tests exercise were not changed
...
- [`docs/archive/v1-1/baseline-and-review-infra/v1.1.0-baseline.md`](../baseline-and-review-infra/v1.1.0-baseline.md) — the `T-0044` baseline this review builds on
- [`docs/archive/v1-1/remediation/engineering-quality/code-quality-review.md`](../remediation/engineering-quality/code-quality-review.md) — prior implementation audit (partially superseded by F2 above; not yet corrected)
- [`docs/archive/v1-1/remediation/engineering-quality/code-quality-gap-analysis.md`](../remediation/engineering-quality/code-quality-gap-analysis.md)
- [`docs/archive/v1-1/remediation/engineering-quality/batch-1a-summary.md`](../remediation/engineering-quality/batch-1a-summary.md) — the remediation pass that fixed part of the prior audit
