...
## Provenance/Attribution Verification Note

The repo does not currently define a concrete provenance/attribution verification item beyond the planning note in `T-0037`.

Best current interpretation:

- it is a deliberately late-stage verification check inserted immediately before final review
...
- it should be small, explicit, and focused on reviewer-trust risks rather than a broad new feature slice
