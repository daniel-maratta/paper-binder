...
- Styling and tokens must converge toward `docs/archive/presentation-history/v1-shipped/ui-ux-contract-v1.md` and `docs/archive/presentation-history/v1-shipped/ui-style.md`; the current CP11 placeholder aesthetic is not the long-term UI baseline.
...
- pre-implementation scope-lock check that `docs/20-architecture/frontend-spa.md`, `docs/20-architecture/frontend-app-route-map.md`, `docs/50-engineering/frontend-standards.md`, `docs/50-engineering/tech-stack.md`, `docs/archive/presentation-history/v1-shipped/ui-ux-contract-v1.md`, `docs/80-testing/test-strategy.md`, and `docs/80-testing/e2e-tests.md` explicitly agree on the CP12 route skeleton, shared primitive set, chosen frontend test command, and component-test posture before broad code changes begin
...
- `docs/archive/v1/checkpoints/pr/cp12-frontend-foundation-and-shared-ui-system/`
- `docs/ai-index.md`
- `docs/repo-map.json`
...
- `NB-6` Accepted and resolved: `docs/archive/v1/checkpoints/checkpoint-status.md` is now included in Likely Touch Points.
