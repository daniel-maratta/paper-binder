...
Inputs reviewed:
- [docs/archive/v1/checkpoints/execution-plan.md](../../execution-plan.md) (CP17 checkpoint definition)
- [docs/archive/v1/checkpoints/phases/phase-5-hardening-release.md](../../phases/phase-5-hardening-release.md)
- [docs/archive/v1/checkpoints/pr/cp17-release-preparation-and-reviewer-snapshot/implementation-plan.md](./implementation-plan.md)
- [docs/archive/v1/checkpoints/checkpoint-status.md](../../checkpoint-status.md) (CP16 done, CP17 queued, no open blockers)
- [docs/95-delivery/staging-and-versioning.md](../../../../../95-delivery/staging-and-versioning.md) (release/versioning baseline)
- [docs/95-delivery/README.md](../../../../../95-delivery/README.md) (delivery lane index)
- [docs/95-delivery/pr/release-pr-description-template.md](../../../../../95-delivery/pr/release-pr-description-template.md) (release artifact shape)
...
- [docs/archive/v1/checkpoints/pr/cp16-hardening-and-consistency-pass/critic-review.md](../cp16-hardening-and-consistency-pass/critic-review.md) (carry-forward residuals: shim longevity, observability ADR hygiene, coverage-parity evidence)
...
- [docs/95-delivery/staging-and-versioning.md](../../../../../95-delivery/staging-and-versioning.md) (which currently says "Release tagging uses the documented release workflow")
...
- [docs/archive/v1/checkpoints/checkpoint-status.md](../../checkpoint-status.md) once CP17 closes (the "main is taggable as V1" signal)
...
- Lock the exact release identifier text. Recommended: `V1` for prose and `v1.0.0` for any tag spelling, since [docs/95-delivery/staging-and-versioning.md](../../../../../95-delivery/staging-and-versioning.md) already names V1 as the final reviewer-ready cut and SemVer is the conventional tag form. If a different convention is preferred, lock it explicitly.
...
Acceptance Criteria say "[docs/95-delivery/](../../) contains a canonical release workflow and release checklist that agree with [docs/95-delivery/staging-and-versioning.md](../../../../../95-delivery/staging-and-versioning.md), the actual script surface, and the CP17 delivery artifact." Touch Points refer to "planned new canonical release docs under `docs/95-delivery/` for the release workflow and release checklist." Neither names the filenames or whether these are one document or two.
...
Required resolution before scope-lock:
- Lock the filenames explicitly. Recommended: two files, [docs/95-delivery/release-workflow.md](../../../../../95-delivery/release-workflow.md) (the procedural sequence — what runs, in what order, who owns what) and [docs/95-delivery/release-checklist.md](../../../../../95-delivery/release-checklist.md) (the closeout gate list — every artifact, command output, and manual evidence required before `main` is taggable). Two files is the lower-risk choice because it lets the checklist stay short and copyable while the workflow doc carries narrative.
- Add a Locked Design Decision naming the two filenames, the relationship between them, and how each links to the CP17 release artifact, [docs/95-delivery/staging-and-versioning.md](../../../../../95-delivery/staging-and-versioning.md), and [docs/archive/v1/checkpoints/execution-plan.md](../../execution-plan.md).
...
- a status line in [docs/archive/v1/checkpoints/checkpoint-status.md](../../checkpoint-status.md) (the current ledger pattern; CP16 row already uses `done` plus a notes column)
...
- the new [docs/95-delivery/release-checklist.md](../../../../../95-delivery/release-checklist.md) (per B6)
...
Required resolution before scope-lock:
- Lock one canonical "taggable" artifact. Recommended: a `Release Readiness` section at the bottom of the new [docs/95-delivery/release-checklist.md](../../../../../95-delivery/release-checklist.md) (per B6), copied verbatim into the CP17 release artifact's `Validation Evidence` section, and reflected in the [docs/archive/v1/checkpoints/checkpoint-status.md](../../checkpoint-status.md) CP17 row notes column. One owner doc, two copies (release artifact and checkpoint ledger) for cross-referencing.
- Add a Locked Design Decision naming the canonical file and the cross-reference rule.
- Add an AC line: "[docs/95-delivery/release-checklist.md](../../../../../95-delivery/release-checklist.md) records the executor-attested release-readiness signal, the CP17 release artifact mirrors it under `Validation Evidence`, and [docs/archive/v1/checkpoints/checkpoint-status.md](../../checkpoint-status.md) CP17 row notes link to both."
...
Treat these as binding for CP17 implementation. They already appear in the plan or are implied by [AGENTS.md](../../../../../../AGENTS.md), [docs/archive/v1/checkpoints/execution-plan.md](../../execution-plan.md), [docs/95-delivery/staging-and-versioning.md](../../../../../95-delivery/staging-and-versioning.md), and prior-checkpoint critic reviews; they are restated here so the executor does not re-open them.
...
- The CP17 release artifact lives in this folder and uses the shape from [docs/95-delivery/pr/release-pr-description-template.md](../../../../../95-delivery/pr/release-pr-description-template.md). The implementation plan and this critic review remain companion delivery docs with distinct purposes.
...
Apply these edits to [docs/archive/v1/checkpoints/pr/cp17-release-preparation-and-reviewer-snapshot/implementation-plan.md](./implementation-plan.md) before scope-lock is declared. All edits flow into the step 1 canonical-doc reconciliation pass already planned.
...
6. **Lock the new release docs filenames** (B6) — add [docs/95-delivery/release-workflow.md](../../../../../95-delivery/release-workflow.md) and [docs/95-delivery/release-checklist.md](../../../../../95-delivery/release-checklist.md) to Locked Design Decisions, Touch Points, AC, Planned Work step 1 reconciliation set, and the [docs/ai-index.md](../../../../../ai-index.md) / [docs/repo-map.json](../../../../../repo-map.json) update list.
7. **Lock the "main is taggable" closeout artifact** (B7) — name [docs/95-delivery/release-checklist.md](../../../../../95-delivery/release-checklist.md) `Release Readiness` section as the canonical signal, the CP17 release artifact `Validation Evidence` section as the mirror, and [docs/archive/v1/checkpoints/checkpoint-status.md](../../checkpoint-status.md) CP17 row notes as the cross-reference. Add the AC line.
...
1. **V1 identifier consistent everywhere.** The locked prose label (recommended `V1`) and tag spelling (recommended `v1.0.0`) appear identically in `CHANGELOG.md`, the CP17 release artifact, [docs/95-delivery/release-workflow.md](../../../../../95-delivery/release-workflow.md), [docs/95-delivery/release-checklist.md](../../../../../95-delivery/release-checklist.md), [README.md](../../../../../../README.md) Status, [REVIEWERS.md](../../../../../../REVIEWERS.md), and the CP17 task file. `rg` for the prose label and tag spelling returns matching hit counts in each file with no orphaned variants.
...
3. **`scripts/run-root-host-e2e.ps1` shim posture matches the lock.** The shim file is present, [docs/95-delivery/release-checklist.md](../../../../../95-delivery/release-checklist.md) names it as a frozen historical compatibility surface, and `validate-docs.ps1` continues to pass against archived CP13-CP15 PR artifacts that reference the old name.
...
6. **New release docs exist and agree with each other.** [docs/95-delivery/release-workflow.md](../../../../../95-delivery/release-workflow.md) and [docs/95-delivery/release-checklist.md](../../../../../95-delivery/release-checklist.md) are present, name every required release gate, output artifact, and manual verification dependency, link to the canonical scripts and to each other, and are referenced from [docs/95-delivery/README.md](../../../../../95-delivery/README.md), the CP17 release artifact, [docs/95-delivery/staging-and-versioning.md](../../../../../95-delivery/staging-and-versioning.md), [docs/ai-index.md](../../../../../ai-index.md), and [docs/repo-map.json](../../../../../repo-map.json).
7. **`Release Readiness` signal recorded in the locked artifact.** [docs/95-delivery/release-checklist.md](../../../../../95-delivery/release-checklist.md) `Release Readiness` section records the executor-attested signal, the CP17 release artifact `Validation Evidence` section mirrors it, and [docs/archive/v1/checkpoints/checkpoint-status.md](../../checkpoint-status.md) CP17 row notes link to both.
...
18. **Taskboard and ledger reflect closure.** [docs/05-taskboard/work-queue.md](../../../../../05-taskboard/work-queue.md) moves the CP17 task to `Recently Done` only after `Status: done` and Outcome are recorded; [docs/archive/v1/checkpoints/checkpoint-status.md](../../checkpoint-status.md) CP17 row reads `done`, `Last completed checkpoint` is set to `CP17`, `Current checkpoint` is `none active`, and `Next checkpoint` reflects the post-V1 state (or is explicitly empty).
...
Inputs re-reviewed:
- [docs/archive/v1/checkpoints/pr/cp17-release-preparation-and-reviewer-snapshot/implementation-plan.md](./implementation-plan.md) (revised after initial critic pass)
- Original critic review above (B1-B7, NB-1 through NB-8, Required Plan Edits 1-16)
- [docs/archive/v1/checkpoints/execution-plan.md](../../execution-plan.md) and [docs/archive/v1/checkpoints/checkpoint-status.md](../../checkpoint-status.md) (unchanged since initial review; no new CP17 row state to reconcile against)
- [docs/95-delivery/staging-and-versioning.md](../../../../../95-delivery/staging-and-versioning.md) (unchanged; locked V1 identifier per B1 is consistent with this baseline)
...
| B6 | New release docs filenames not locked | Locked Design Decisions name [docs/95-delivery/release-workflow.md](../../../../../95-delivery/release-workflow.md) and [docs/95-delivery/release-checklist.md](../../../../../95-delivery/release-checklist.md) as two distinct files with declared roles; both appear in step 1 reconciliation, AC, Touch Points, and the navigation-metadata update list | Pass |
| B7 | "Main is taggable" closeout artifact unspecified | Locked Design Decisions name [docs/95-delivery/release-checklist.md](../../../../../95-delivery/release-checklist.md) `Release Readiness` section as the canonical signal, with the CP17 release artifact `Validation Evidence` mirror and the `docs/archive/v1/checkpoints/checkpoint-status.md` CP17 row notes as cross-reference; AC line locks the same triplet | Pass |
...
6. **`docs/95-delivery/README.md` "Read First" pointers may need to expand.** The new [docs/95-delivery/release-workflow.md](../../../../../95-delivery/release-workflow.md) and [docs/95-delivery/release-checklist.md](../../../../../95-delivery/release-checklist.md) are added to step 1 reconciliation, but currently only [docs/95-delivery/staging-and-versioning.md](../../../../../95-delivery/staging-and-versioning.md) is in the delivery README's "Read First" block. Verify the delivery README's read-first list is updated in the same change set so the new release docs are surfaced to a fresh reviewer.
...
- New files: [docs/95-delivery/release-workflow.md](../../../../../95-delivery/release-workflow.md), [docs/95-delivery/release-checklist.md](../../../../../95-delivery/release-checklist.md), [description.md](./description.md), [T-0032-cp17-release-preparation-and-reviewer-snapshot.md](../../../../../05-taskboard/tasks/T-0032-cp17-release-preparation-and-reviewer-snapshot.md)
...
- release identity is prose `V1` plus tag `v1.0.0`, consistent across [CHANGELOG.md](../../../../../../CHANGELOG.md), [release-workflow.md](../../../../../95-delivery/release-workflow.md), [release-checklist.md](../../../../../95-delivery/release-checklist.md), [README.md](../../../../../../README.md), [REVIEWERS.md](../../../../../../REVIEWERS.md), [checkpoint-status.md](../../checkpoint-status.md), [T-0032](../../../../../05-taskboard/tasks/T-0032-cp17-release-preparation-and-reviewer-snapshot.md), and [description.md](./description.md)
...
- the taskboard ([work-queue.md](../../../../../05-taskboard/work-queue.md)) and ledger ([checkpoint-status.md](../../checkpoint-status.md)) both reflect CP17 closure with `Last completed checkpoint: CP17`, `Current checkpoint: none active`, and `Next checkpoint: none planned (post-V1 owner-directed work only)`
...
The [release-checklist.md](../../../../../95-delivery/release-checklist.md) `Release Readiness` section exposes: Release label, Recommended tag, Status, Executor attestation, Owner-controlled action pending, Mirrors. The CP17 [description.md](./description.md) mirrors the same field set. The match is correct in this pass.
...
Recommendation: non-blocking. Suggest locking the field set in [release-workflow.md](../../../../../95-delivery/release-workflow.md) `Sequence` step 5 at the next time the release workflow is revisited.
...
4. **Validator coverage is specific, not generic.** [validate-docs.ps1](../../../../../../scripts/validate-docs.ps1) hard-codes the CP17 artifact path (`docs/archive/v1/checkpoints/pr/cp17-release-preparation-and-reviewer-snapshot/description.md`) inside `Assert-ReleaseChecklistStructure`. A post-V1 release will need to either parameterize the artifact path or update the constant. Acceptable for V1 since there is only one release artifact in scope, but worth generalizing before the next release cut.
