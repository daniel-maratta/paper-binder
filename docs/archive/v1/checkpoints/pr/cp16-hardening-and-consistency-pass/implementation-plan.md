...
- `docs/archive/v1/checkpoints/execution-plan.md`
...
- `docs/archive/v1/checkpoints/pr/cp16-hardening-and-consistency-pass/`
- `docs/ai-index.md`
- `docs/repo-map.json`
