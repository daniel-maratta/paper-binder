...
Input: `docs/archive/v1/checkpoints/pr/cp10-document-domain-and-immutable-document-rules/implementation-plan.md`, `docs/archive/v1/checkpoints/pr/cp10-document-domain-and-immutable-document-rules/critic-review.md` (revision 2), current diff, author notes
