...
- Changed files:
  ...
  - Canonical docs and execution artifacts: `README.md`, the CP14 task/PR artifacts, product docs under `docs/10-product/`, architecture/testing/operations docs, `docs/archive/v1/checkpoints/checkpoint-status.md`, `docs/ai-index.md`, and `docs/repo-map.json`
- Validation results:
