...
- `docs/archive/v1/checkpoints/checkpoint-status.md` is the canonical checkpoint-level progress ledger.
...
- checkpoint entry in `docs/archive/v1/checkpoints/checkpoint-status.md` when checkpoint status changes
