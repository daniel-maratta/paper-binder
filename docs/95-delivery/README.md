...
Status: every folder currently under `docs/archive/v1/checkpoints/pr/` (`cp1-...` through `cp17-...`) is a historical `V1` checkpoint PR artifact, retained for auditability and provenance. They are not current `v1.1.x` guidance. Published `v1.1.2` delivery evidence lives in `docs/95-delivery/release-checklist.md`, `docs/95-delivery/v1-1-2-implementation-plan.md`, `docs/05-taskboard/v1-1-2-backlog.md`, and `T-0056`; validated PR-ready `v1.1.3` hotfix evidence lives in `docs/95-delivery/release-checklist.md` and `T-0057`; completed `v1.1.1` delivery evidence lives in `docs/95-delivery/release-checklist.md`, `docs/95-delivery/v1-1-1-implementation-plan.md`, `docs/95-delivery/v1-1-1-legal-readiness-plan.md`, `docs/95-delivery/v1-1-1-legal-retention-inventory.md`, and the `T-0046` through `T-0055` task files under `docs/05-taskboard/tasks/`; the `v1.1.x` releases do not use per-PR folders under `pr/` the way the `V1` checkpoints did.
