...
- Current version metadata: `1.1.0`
- Changelog cut shape:
...
- Release tags must match `vMAJOR.MINOR.PATCH`; `v1.0.0` is the historical first valid `V1` tag and `v1.1.0` is the current stable tag.
