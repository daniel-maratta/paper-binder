...
- `Release`: a stable shipped cut on the `V1` line. The initial reviewer-ready cut used prose `V1` with tag `v1.0.0`; the current stable tag is `v1.0.4`.
...
- The current stable release identity is `V1` / `v1.0.4` / `1.0.4`.
