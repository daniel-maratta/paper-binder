...
- The active `v1.1.3` branch may stage `1.1.3` metadata as a patch candidate, but `v1.1.3` is not the current stable tag until release close-out records the taggable state and owner-controlled release actions complete.
